...
class TaxServiceTest extends TestCase
{
    ...
    public function test_screens_and_exports_render(): void
    {
        ...
        $this->actingAs($user)->get(route('report.gstr1', $q))->assertOk()->assertSee('GSTR-1', false);
        $this->actingAs($user)->get(route('report.gstr3b', $q))->assertOk()->assertSee('Net GST payable', false);
