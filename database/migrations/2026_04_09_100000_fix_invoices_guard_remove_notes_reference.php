...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // The invoices_accounting_guard trigger references NEW.notes but the
        // invoices table has no 'notes' column. This causes a runtime error
        // when transitioning a finalized invoice to cancelled (reversal flow).
        // Fix: remove the NEW.notes IS DISTINCT FROM OLD.notes check.
        DB::unprepared(<<<'SQL'
...
SQL);
    ...
    {
        // Intentionally not reverting — the old trigger with NEW.notes is broken
    }
};
