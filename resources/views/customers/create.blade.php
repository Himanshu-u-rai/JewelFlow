        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white shadow-sm">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-500 mt-1">Enter the details of the new customer</p>
                </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="address" 
                                      ...
                                      class="w-full border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500 @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" id="notes" rows="2"
                                      ...
                                      class="w-full border-gray-300 shadow-sm focus:border-amber-500 focus:ring-amber-500 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        Mobile number must be unique for each customer. You can add more details later from the customer profile.
                                    </p>
                                </div>
                            </div>
                        </div>
