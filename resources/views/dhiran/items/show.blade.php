            ...
            <div class="lg:col-span-2">
                <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 mb-6">
                    ...
                    <dl class="grid grid-cols-2 md:grid-cols-3 gap-x-6 gap-y-4 text-sm">
                        ...
                        <div><dt class="text-[11px] uppercase tracking-[0.16em] text-slate-400">Purity</dt><dd class="text-slate-800 mt-0.5">@if(($item->metal_type ?? "gold") === "other")—@else{{ rtrim(rtrim((string) $item->purity, "0"), ".") }}{{ ($item->metal_type ?? "gold") === "silver" ? "" : "K" }}@endif</dd></div>
