<x-super-admin.layout>
    ...
    <div class="admin-panel admin-table-panel mb-6">
        ...
        <div class="admin-table-footer">Showing {{ $queueStats->count() }} active queue{{ $queueStats->count() === 1 ? '' : 's' }}.</div>
    </div>
    @endif
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm admin-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" class="px-4 py-4 text-center text-slate-400">No queued jobs.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        <div class="admin-table-footer">Showing latest {{ count($jobs) }} queued/reserved job{{ count($jobs) === 1 ? '' : 's' }}.</div>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-sm admin-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" class="px-4 py-4 text-center text-slate-400">No failed jobs.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        <div class="admin-table-footer">Showing latest {{ count($failedJobs) }} failed job{{ count($failedJobs) === 1 ? '' : 's' }}.</div>
    </div>
</x-super-admin.layout>
