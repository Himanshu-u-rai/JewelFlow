...
<style>
    ...
    .pos-product-price { font-size: 16px; font-weight: 700; color: var(--accent); }
    .pos-product-add {
    ...
    .cust-opt:active { background: rgba(13,148,136,.12); }
    ...
    .checkout-total .checkout-row-val { font-weight: 700; color: var(--accent); font-size: 18px; }
    .btn-checkout {
