            ...
            <div class="sidebar" id="main-sidebar" data-mobile-drawer="tenant" data-turbo-permanent>
                ...
                <div class="sidebar-nav" id="sidebar-nav">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="{{ route('report.transactions') }}" class="nav-link {{ request()->routeIs('report.transactions') ? 'active' : '' }}">
                            <span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 15h3"/><path d="M7 11h5"/><path d="M7 7h7"/><path d="M17 17h.01"/></svg></span>
