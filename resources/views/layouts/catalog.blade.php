    ...
    <nav class="cat-nav">
        <div class="cat-nav-inner">
            ...
            <div style="display:flex;align-items:center;gap:12px">
                @php
                    $waNumber = \App\Support\Mobile::forWhatsApp($shop->shop_whatsapp ?? $shop->phone ?? '');
                @endphp
                @if($waNumber)
                ...
                <div class="cat-footer-brand">
                    ...
                    <div class="cat-footer-social">
                        @if($catalogSettings->social_whatsapp)
                            <a href="https://wa.me/{{ \App\Support\Mobile::forWhatsApp($catalogSettings->social_whatsapp) }}" target="_blank" rel="noopener" title="WhatsApp">
